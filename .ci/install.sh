...
export OPAMYES=true
opam init
opam repository add jean-claude git+https://github.com/msprotz/opam-repository
...
git clone --branch c_record_aead --single-branch https://github.com/FStarLang/FStar.git fstar
