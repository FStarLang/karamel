...
git clone --branch protz_uint128 --single-branch --depth 1 https://github.com/FStarLang/FStar.git fstar
git clone --branch protz_uint128 --single-branch --depth 1 https://github.com/mitls/hacl-star
