...
{
  return projectee.smtencoding_nl_arith_repr;
}
...
{
  return projectee.trivial_pre_for_unannotated_effectful_fns;
}

FStar_Pervasives_Native_option__Prims_string
FStar_VConfig___proj__Mkvconfig__item__reuse_hint_for(FStar_VConfig_vconfig projectee)
{
  return projectee.reuse_hint_for;
}
