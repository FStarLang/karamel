...
/* This file was generated by KreMLin <https://github.com/FStarLang/kremlin> then hand-edited to use MSVC intrinsics
 * KreMLin invocation: C:\users\barrybo\mitls2c\kremlin\_build\src\Kremlin.native -minimal -fnouint128 C:/users/barrybo/mitls2c/FStar/ulib/FStar.UInt128.fst -tmpdir ../secure_api/out/runtime_switch/uint128 -skip-compilation -add-include "kremlib0.h" -drop FStar.Int.Cast.Full -bundle FStar.UInt128=FStar.*,Prims
 * F* version: 15104ff8
...
FStar_UInt128_uint128 FStar_UInt128_add(FStar_UInt128_uint128 a, FStar_UInt128_uint128 b)
{
  ...
  unsigned char carry = _addcarryx_u64(0, a.low, b.low, &l); // low/CF = a.low+b.low+0
...
FStar_UInt128_add_underspec(FStar_UInt128_uint128 a, FStar_UInt128_uint128 b)
{
  ...
  return
    (
      (FStar_UInt128_uint128){
        .low = a.low + b.low,
        .high = FStar_UInt64_add_underspec(FStar_UInt64_add_underspec(a.high, b.high),
...
FStar_UInt128_sub_underspec(FStar_UInt128_uint128 a, FStar_UInt128_uint128 b)
{
  ...
  return
    (
      (FStar_UInt128_uint128){
        .low = a.low - b.low,
        .high = FStar_UInt64_sub_underspec(FStar_UInt64_sub_underspec(a.high, b.high),
...
FStar_UInt128_uint128 FStar_UInt128_eq_mask(FStar_UInt128_uint128 a, FStar_UInt128_uint128 b)
{
  ...
  __m128i s64 = _mm_shuffle_epi32(ret64, _MM_SHUFFLE(1,0,3,2)); // 3,2,1,0 -> 1,0,3,2
  // And them together
...
FStar_UInt128_uint128 FStar_UInt128_gte_mask(FStar_UInt128_uint128 a, FStar_UInt128_uint128 b)
{
    ...
    __m128i ge2=_mm_srli_si128(ge1, 4); // shift original ge from 3,2,1,0 to 0x0,0x0,3,2
    __m128i t2 =_mm_and_si128(eq0, _mm_and_si128(eq1, ge2)); // t2 = (eq0 & eq1 & ge2)
            ret = _mm_or_si128(ret, t2);
    __m128i eq2=_mm_srli_si128(eq1, 4); // shift eq from 3,2,1,0 to 0x0,00,00,3
    __m128i ge3=_mm_srli_si128(ge2, 4); // shift original ge from 3,2,1,0 to 0x0,0x0,0x0,3
    __m128i t3 = _mm_and_si128(eq0, _mm_and_si128(eq1, _mm_and_si128(eq2, ge3))); // t3 = (eq0 & eq1 & eq2 & ge3)
            ret = _mm_or_si128(ret, t3);
    return _mm_shuffle_epi32(ret, _MM_SHUFFLE(0,0,0,0)); // the result is in 0.  Shuffle into all dwords.
#else
  return
    (
      (FStar_UInt128_uint128){
