...
extern Prims_int FStar_Krml_Endianness_be_to_n(Prims_list__uint8_t *b);

KRML_DEPRECATED("FStar.Endianness.n_to_le")

extern Prims_list__uint8_t *FStar_Krml_Endianness_n_to_le(uint32_t len, Prims_int n);

KRML_DEPRECATED("FStar.Endianness.n_to_be")

extern Prims_list__uint8_t *FStar_Krml_Endianness_n_to_be(uint32_t len, Prims_int n);
...
*FStar_Krml_Endianness_seq_uint32_of_le(Prims_int l, Prims_list__uint8_t *b);
...
extern Prims_list__uint32_t
*FStar_Krml_Endianness_seq_uint32_of_be(Prims_int l, Prims_list__uint8_t *b);
...
*FStar_Krml_Endianness_seq_uint64_of_le(Prims_int l, Prims_list__uint8_t *b);
...
extern Prims_list__uint64_t
*FStar_Krml_Endianness_seq_uint64_of_be(Prims_int l, Prims_list__uint8_t *b);
