...
#ifndef KRML_HEADER_FStar_Monotonic_Heap_H
#define KRML_HEADER_FStar_Monotonic_Heap_H
...
#define KRML_HEADER_FStar_Monotonic_Heap_H_DEFINED
#endif /* KRML_HEADER_FStar_Monotonic_Heap_H */
